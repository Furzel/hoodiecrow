...
module.exports = function(connection, parsed, data, callback){
    ...
    connection.send({
        ...
        command: "OK",
        attributes:[
            { type: "SECTION", section:[{type: "ATOM", value: "PERMANENTFLAGS"}, permanentFlags] },
            { type: "TEXT", value: "Permanent flags"}
        ]
    ...
    connection.send({
        ...
        command: "OK",
        attributes:[
            { type: "SECTION", section:[{type: "ATOM", value: "UIDVALIDITY"}, mailbox.uidvalidity] },
            { type: "TEXT", value: "UIDs valid" }
        ]
    ...
    connection.send({
        ...
        command: "OK",
        attributes:[
            { type: "SECTION", section:[{type: "ATOM", value: "UIDNEXT"}, mailbox.uidnext] },
            { type: "TEXT", value: "Predicted next UID." }
        ]
